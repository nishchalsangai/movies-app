...
class UpcomingMoviesResponse {
    Dates dates;
    int page;
    List<UpcomingMovieModel> results;
    int totalPages;
    int totalResults;
    ...
    factory UpcomingMoviesResponse.fromJson(Map<String, dynamic> json) => UpcomingMoviesResponse(
        dates: Dates.fromJson(json["dates"]),
        page: json["page"],
        results: List<UpcomingMovieModel>.from(json["results"].map((x) => UpcomingMovieModel.fromJson(x))),
